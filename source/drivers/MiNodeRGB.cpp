...
MiNodeRGB::MiNodeRGB(int id, ConnName connName) :
CLOCK(MiNodeConn::calcP0Name(connName)) , DATA(MiNodeConn::calcP1Name(connName))
{
  this->id = id;
}

MiNodeRGB::MiNodeRGB(int id, PinName pinName1, PinName pinName2) :
CLOCK(pinName1) , DATA(pinName2)
{
  this->id = id;
}
